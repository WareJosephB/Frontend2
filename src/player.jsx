        ...
        return(
            <div id = 'playerfields'>
                ...
                <form id='updatePlayerForm' onSubmit = {updatePlayer}>
                    ...
                    <input className='quarter' id = 'Get Player' type = 'button' value = 'Choose Player to Update' onClick={this.handleClick} />
                    <input className='quarter' id = 'Update Name' type = 'text' placeholder={this.state.playerName}/>
                    <input className='quarter' id = 'Update Player' type = 'submit' value = 'Confirm Update' disabled={this.state.buttonWorks}/>
                </form>
                <br/>
